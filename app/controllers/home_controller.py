...
def index():
    lest_fights = get_last_n_fights()
    fight_statistics = get_methods_statistics()
    pound_4_pound = get_pound_4_pound_ranking()
    fighter_statistics = get_fighter_statistics()

    return render_template('dashboard.html', last_n_fights=lest_fights, fight_statistics=fight_statistics, pound_4_pound_ranking=pound_4_pound, fighter_statistics=fighter_statistics)
